...
# Block
################################################################################
dir_model = joinpath(module_dir(), "src/dynamics/block")
dir_sim   = joinpath(module_dir(), "src/simulation/block")
...
# Block 1D
################################################################################
dir_model = joinpath(module_dir(), "src/dynamics/block_1D")
dir_sim   = joinpath(module_dir(), "src/simulation/block_1D")
